...
[Collected Data](https://github.com/psych251/dehaene2009/blob/main/task/jspsych/jspsych-6.1.0/task/mirrorinvariance1.html)
...
Median correct response times were analyzed using an ANOVA with group as a between-subjects factor and stimulus category, repetition (same or different image) and orientation of the first image (normal or mirror; the second image was always in normal orientation) as within-subject factors. 

In this replication study, I will focus on response time between written scripts compared to pictures (face and objects combined) as shown in the Figure 7 of the study. 
...
#### Differences from pre-data collection methods plan
 Data will be collected through prolific instead of an in-lab setting. Additionally, images in the behavioral tasks were different from the previous study.
...
ID and five categories where there will be: Normal Pair Same, Normal Pair Different, Mirror Same,and Mirror Different categories. All columns will be used for the [analysis](https://github.com/psych251/dehaene2009.git/)
...
The analyses as specified in the analysis plan will was followed. Median correct response times will be analyzed using ANOVA to test group category effects of mirror invariance.
...
![Figure from pilot data](/Users/cherrysseulsa/Desktop/image_proj.png )

## Discussion

### Summary of Replication Attempt

In the pilot of two participants, the result was not replicated as median response times did not vary significantly accross categories.
